(function (global, factory) {
    ...
    */
    ...
    var css_248z$e = ".coords-module_coords-top__ARhTf, body *.coords-module_coords-top__ARhTf {\n    top: var(--coordTop);\n  }\n  .coords-module_coords-left__fhcnM, body *.coords-module_coords-left__fhcnM {\n    left: var(--coordLeft);\n  }\n  .coords-module_coords-right__5Fe8-, body *.coords-module_coords-right__5Fe8- {\n    right: var(--coordRight);\n  }\n  .coords-module_coords-bottom__nwDJx, body *.coords-module_coords-bottom__nwDJx {\n    bottom: var(--coordBottom);\n  }";
    var styles$e = {"coords-top":"coords-module_coords-top__ARhTf","coords-left":"coords-module_coords-left__fhcnM","coords-right":"coords-module_coords-right__5Fe8-","coords-bottom":"coords-module_coords-bottom__nwDJx"};
    styleInject(css_248z$e);

    function getCoords(_a) {
        var props = _a.props;
        return [
            props.top ? styles$e['coords-top'] : null,
            props.left ? styles$e['coords-left'] : null,
            props.right ? styles$e['coords-right'] : null,
            props.bottom ? styles$e['coords-bottom'] : null,
        ];
    }
    ...
    var Button = function (_a) {
        ...
        var classList = classnames.apply(void 0, __spreadArray(__spreadArray(__spreadArray(__spreadArray([], getCoords({
            ...
            pr: pr,
            pt: pt,
        }), false), [styles$d.baseButton,
            styles$d["variant-".concat(variant)]], false));
        ...
        return (React__default["default"].createElement("div", null,
            React__default["default"].createElement("button", { style: __assign(__assign(__assign({}, getCoordsStyle({ top: top, left: left, right: right, bottom: bottom })), getMarginsStyles({ m: m, mb: mb, ml: ml, mr: mr, mt: mt })), getPaddingsStyles({ p: p, pb: pb, pl: pl, pr: pr, pt: pt })), className: classList, onClick: action, disabled: disabled, type: type },
                React__default["default"].createElement("div", { className: styles$d.inner },
                    icon && iconPosition === 'left' && (React__default["default"].createElement("div", { className: styles$d.icon }, Icon)),
                    children,
                    icon && iconPosition === 'right' && (React__default["default"].createElement("div", { className: styles$d.icon }, Icon))))));
    };
    ...
    var css_248z$c = ".ButtonGroup-module_baseButtonGroup__G5x-4 {\n  display: grid;\n  grid-auto-columns: 1fr;\n  grid-auto-flow:column;\n  -moz-column-gap: 1.6rem;\n       column-gap: 1.6rem;\n}\n";
    var styles$c = {"baseButtonGroup":"ButtonGroup-module_baseButtonGroup__G5x-4"};
    styleInject(css_248z$c);

    var ButtonGroup = function (_a) {
        var children = _a.children;
        var classList = classnames(styles$c.baseButtonGroup);
